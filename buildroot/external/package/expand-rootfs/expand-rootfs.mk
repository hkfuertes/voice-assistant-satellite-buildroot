...
define EXPAND_ROOTFS_INSTALL_TARGET_CMDS
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_CUSTOM_PACKAGES_PATH)/package/expand-rootfs/files/rootfs-resizer \
		$(TARGET_DIR)/usr/bin/rootfs-resizer
endef

define EXPAND_ROOTFS_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_CUSTOM_PACKAGES_PATH)/package/expand-rootfs/files/S01expand-rootfs \
