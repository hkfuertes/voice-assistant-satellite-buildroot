...
SEEED_VOICECARD_DEPENDENCIES = rpi-firmware dtc host-dtc
...
define SEEED_VOICECARD_INSTALL_TARGET_CMDS
	...
	mkdir -p $(TARGET_DIR)/etc/init.d
		$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_CUSTOM_PACKAGES_PATH)/package/seeed-voicecard/files/S80seeed-voicecard \
			$(TARGET_DIR)/etc/init.d/S80seeed-voicecard
