...
define WIFI_AUTOCONFIG_INSTALL_TARGET_CMDS
	...
	test -f $(BR2_EXTERNAL_CUSTOM_PACKAGES_PATH)/package/wifi-autoconfig/files/wpa_supplicant.conf && \
		$(INSTALL) -D -m 0600 $(BR2_EXTERNAL_CUSTOM_PACKAGES_PATH)/package/wifi-autoconfig/files/wpa_supplicant.conf \
		$(TARGET_DIR)/etc/wpa_supplicant.conf || true
endef

define WIFI_AUTOCONFIG_INSTALL_INIT_SYSV
	$(INSTALL) -D -m 0755 $(BR2_EXTERNAL_CUSTOM_PACKAGES_PATH)/package/wifi-autoconfig/files/S39wifi-autoconfig \
