################################################################################
#
# python-numpy-wheel - precompiled numpy wheel installer
#
################################################################################
...
ifeq ($(BR2_aarch64),y)
    ...
    PYTHON_NUMPY_WHEEL_ARCH = x86_64
    PYTHON_NUMPY_WHEEL_SITE = https://files.pythonhosted.org/packages/9e/7e/7d306ff7cb143e6d975cfa7eb98a93e73495c4deabb7d1b5ecf09ea0fd69
    PYTHON_NUMPY_WHEEL_SOURCE = numpy-2.3.4-cp313-cp313-manylinux_2_27_x86_64.manylinux_2_28_x86_64.whl
else
    $(error Unsupported architecture for python-numpy-wheel. Supported: aarch64, arm, x86_64)
endif
