...
PYTHON_PYOPENWAKEWORD_DEPENDENCIES = python-numpy tensorflow-lite-c-prebuilt

define PYTHON_PYOPENWAKEWORD_POST_INSTALL_MAKE_LNS
	mkdir -p $(TARGET_DIR)/usr/lib/python$(PYTHON3_VERSION_MAJOR)/site-packages/pyopen_wakeword/lib
	ln -sf /usr/lib/libtensorflow-lite.so \
		$(TARGET_DIR)/usr/lib/python$(PYTHON3_VERSION_MAJOR)/site-packages/pyopen_wakeword/lib/libtensorflowlite_c.so
endef
